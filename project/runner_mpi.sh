...
# Static Strips
mpirun -np $SLURM_NPROCS raytrace_mpi -h 100 -w 100 -c configs/twhitted.xml -p static_strips_vertical 
# Static Cycles
#mpirun -np $SLURM_NPROCS raytrace_mpi -h 100 -w 100 -c configs/twhitted.xml -p static_cycles_horizontal -cs 1
# Static Blocks
